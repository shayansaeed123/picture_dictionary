...
Future<int> getSelectedIndex() async {
  ...
  Future<Map<String, dynamic>> questionApi()async{
    final response = await http.post(
      Uri.parse('https://kulyatudawah.com/public/vocgame/apis/wheels_add_question_answers_status_voice.php'),
      body: {
  ...
  final response = await http.post(
    Uri.parse('https://kulyatudawah.com/public/vocgame/apis/wheels_count_question_answers_voice.php'),
    body: {
      'user_id': MySharedPrefrence().get_user_id().toString(),
      'type_id': widget.selectedCategory.toString(),
    },
