...
//       Uri.parse('${PictureRepo.baseUrl}apis/add_question_answers_status.php'),
//       body: {
...
//   final response = await http.post(
//     Uri.parse('${PictureRepo.baseUrl}apis/count_question_answers.php'),
//     body: {
//       'user_id': MySharedPrefrence().get_user_id().toString(),
//       'type_id': widget.selectedCategory.toString(),
//     },
...
//           List<dynamic> word_break_options = items[0]['word_break_options'];
...
//                               ),
//                   child: Center(
//                                   child: Image.network(items[0]['image'],
//                                       fit: BoxFit.cover,
...
//                   children: word_break_options.map<Widget>((word) {
//                     return Container(
...
//                                 ),
//                       child: Center(
//                         child: reusabletext(word, colorController.blackColor, 18)
//                       ),
//                     );
//                   }).toList(),),
//           )
